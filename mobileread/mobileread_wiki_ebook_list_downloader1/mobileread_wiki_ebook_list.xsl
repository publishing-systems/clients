...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/html">
    <mobileread-wiki-ebook-list>
      <xsl:comment> This file was generated by mobileread_wiki_ebook_list.xsl of mobileread_wiki_ebook_list_downloader1, which is free software licensed under the GNU Affero General Public License 3 or any later version (see https://github.com/publishing-systems/clients/ and http://www.publishing-systems.org). </xsl:comment><xsl:text>&#xA;</xsl:text>
      <xsl:apply-templates/>
    </mobileread-wiki-ebook-list>
  </xsl:template>
